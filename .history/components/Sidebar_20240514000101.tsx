    ...
    <div className="hidden md:block w-[20%] h-fit border border-gray-300 bg-white rounded">
      <div className="flex relative flex-col items-center">
        ...
        <div className="border-b border-b-gray-300">
          <div className="p-2 mt-5 text-center">
            <h1 className="font-bold hover:underline cursor-pointer">
              {user ? `${user?.firstName} ${user?.lastMame}` : "Rajratan More"}
            </h1>
            <p className="text-xs">
        ...
        <div className="text-xs">
            <div className="w-full flex justify-between items-center pc-3 py-2 hover:bg-gray-200">
                <p>
                    Post Impression
                </p>
                <p className="text-blue-500 font">
                    88
                </p>
